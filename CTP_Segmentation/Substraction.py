...
for case in cases:
    ...
    if case != '001':  
        ...
        subtraction_file_path = os.path.join(path, 'Subtraction')
        ...
        #Read
        ctp_0 = nib.load(os.path.join(path, 'CTP_0.nii')).get_fdata()
        ctp_0.shape
        ...
        while times <= 22:
            ...
            ctp_1 = nib.load(os.path.join(path, 'CTP_{}.nii'.format(times))).get_fdata()
