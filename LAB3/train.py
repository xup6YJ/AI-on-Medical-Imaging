...
def train3d(args):
    ...
    ## modify
    train_dataset = COVIDDataset(curriculum=args.curriculum, validation = False)
    val_dataset = COVIDDataset(validation = True)
...
if __name__ == '__main__':
    ...
    # for model
    parser.add_argument('--model', type=int, required=False, default=2)
    parser.add_argument('--in_channel', type=int, required=False, default=1)
    parser.add_argument('--out_channel', type=int, required=False, default=1)
    parser.add_argument('--init_ch', type=int, required=False, default=32)
    parser.add_argument('--deconv', action='store_false', default=False)
    parser.add_argument('--weight_init', type=str, required=False, default='kaiming')
    parser.add_argument('--cr_cpt_path', type=str, required=False)

    # for UNet3P
    parser.add_argument('--reduce_ch', type=int, required=False, default=64)

    # for RUNet, R2UNet
    parser.add_argument('--num_rcnn', type=int, required=False, default=2)
    parser.add_argument('--t', type=int, required=False, default=2)

    # for classification guided module (multi-task)
    parser.add_argument('--cgm', action='store_false', default=False)
    parser.add_argument('--cgm_weight', type=float, required=False, default=0.2)

    # for focal tversky loss
    parser.add_argument('--ft_alpha', type=float, required=False, default=0.7)
    parser.add_argument('--ft_beta', type=float, required=False, default=0.3)
    parser.add_argument('--ft_gamma', type=float, required=False, default=0.75)

    # for unified focal loss
    parser.add_argument('--uf_weight', type=float, required=False, default=0.5)
    parser.add_argument('--uf_delta', type=float, required=False, default=0.6)
    parser.add_argument('--uf_gamma', type=float, required=False, default=0.2)

    # for boundary loss
    parser.add_argument('--bd_loss', action='store_false', default=False)
    parser.add_argument('--bd_loss_weight', type=float, required=False, default=0.2)
    ...
    parser.add_argument('--criterion', type=str, required=False, default='Dice')

    # for lr scheduler
    parser.add_argument('--reduce_lr_on_plateau', action='store_true', default=True)
    parser.add_argument('--exponential_lr', action='store_false', default=False)
    parser.add_argument('--step_lr', action='store_false', default=False)

    # for dataloader
    parser.add_argument('--dataset', type=str, required=False, default='COVID')
    ...
    parser.add_argument('--queue_length', type=int, required=False, default=1000)
    parser.add_argument('--samples_per_volume', type=int, required=False, default=16)

    parser.add_argument('--continue_epoch', type=int, required=False)
    parser.add_argument('--continue_batch_done', type=int, required=False)
    parser.add_argument('--continue_cpt_path', type=str, required=False)

    parser.add_argument('--curriculum', action='store_true', default=True)
    parser.add_argument('--no_noisy', action='store_false', default=False)
    parser.add_argument('--continue_training', action='store_false', default=False)
    parser.add_argument('--test_time_aug', action='store_false', default=False)

    parser.add_argument('--cpt_dir', type=str, required=False, default='COVID.cpts')
    parser.add_argument('--log_dir', type=str, required=False, default='COVID.logs')
    parser.add_argument('--task_name', type=str, required=False, default='COVID_seg')
    parser.add_argument('--task_name_suffix', type=str, required=False)
